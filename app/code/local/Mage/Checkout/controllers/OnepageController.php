...
//		} catch (Exception $ex) {  }
	    ...
	    $fromEmail = "info@toner.com"; // sender email address
	    $fromName = "Your Website"; // sender name

	    $toEmail = "carlos@faranani.net"; // recipient email address
	    $toName = "Johan"; // recipient name

	    $body = "A new checkout has just occurred with order number ".$orderID.", please visit your magento admin area ASAP."; // body text
	    $subject = "New Checkout"; // subject text
