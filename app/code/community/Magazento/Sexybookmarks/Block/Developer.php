...
class Magazento_Sexybookmarks_Block_Developer extends Mage_Adminhtml_Block_System_Config_Form_Fieldset {
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        ...
        $content.= '<div class="magazento">';
            $content.= '<a href="http://www.magazento.com/" target="_blank"><img src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/default/default/magazento/sexybookmarks/promo.jpg" alt="www.magazento.com" /></a>';
