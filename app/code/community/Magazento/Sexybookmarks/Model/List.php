...
class Magazento_Sexybookmarks_Model_List extends Mage_Core_Model_Abstract {

    public function getBookmarksList() {
        return Mage::getStoreConfig('sexybookmarks/options/bookmarkslist');
    }
    public function getApiKey() {
        return Mage::getStoreConfig('sexybookmarks/options/apikey');
    }
    public function getSource() {
        return Mage::getStoreConfig('sexybookmarks/options/source');
    }
